...
import rreeggkk.nuclearsciences.client.gui.inventory.GuiFuelPacker;
...
public class GuiHandler implements IGuiHandler {
	...
	public static final int FUEL_PACKER = 4; 
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tile != null) {
			switch(ID) {
				...
				case FUEL_PACKER:
					return new ContainerFuelPacker(player.inventory, (TileEntityFuelPacker)tile);
				default:
					return null;
			}
		}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tile != null) {
			switch(ID) {
				...
				case FUEL_PACKER:
					return new GuiFuelPacker(new ContainerFuelPacker(player.inventory, (TileEntityFuelPacker)tile));
				default:
					return null;
			}
		}
